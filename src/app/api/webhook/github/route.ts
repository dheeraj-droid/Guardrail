// Spec I — Gateway Webhook Receiver (SRD Module 1).
// THIN shell: verify HMAC (Law 4), acknowledge 202 immediately, defer the pipeline
// (Law 5). Zero business logic lives here — everything else is delegated to
// verifyGithubSignature (Track A) and processPullRequest (Track H).
 ...
 * vitest, so the handler takes optional injection points. Prod wiring (POST below) uses
 * every default.
 */
